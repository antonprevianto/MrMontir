...
public class MrMontirApp {

    private static final Logger log = LoggerFactory.getLogger(MrMontirApp.class);

    private final Environment env;

    public MrMontirApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MrMontir.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MrMontirApp.class);
